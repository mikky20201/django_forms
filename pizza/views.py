...
def order(request):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
            ...
            note = f"Thanks for ordering! Your {filled_form.cleaned_data['size']} pizza with {filled_form.cleaned_data['topping1']} and {filled_form.cleaned_data['topping2']}is on its way"
